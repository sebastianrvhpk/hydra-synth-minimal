import type { HydraDependencyEdge, HydraKernelGraph } from './types.js'
...
export const validateKernelGraph = (graph: HydraKernelGraph): HydraKernelGraphValidationIssue[] => {
...
export const throwOnKernelGraphErrors = (
  issues: HydraKernelGraphValidationIssue[],
  label = 'HydraKernelGraph'
): void => {
