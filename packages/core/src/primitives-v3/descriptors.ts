import type { HydraPrimitiveDescriptorV3 } from './types.js'

export const PRIMITIVE_DESCRIPTORS_V3: HydraPrimitiveDescriptorV3[] = [
  {
...
export const getPrimitiveDescriptorByKindV3 = (
  kind: HydraPrimitiveDescriptorV3['kind']
): HydraPrimitiveDescriptorV3 | undefined => PRIMITIVE_DESCRIPTORS_V3.find((descriptor) => descriptor.kind === kind)
