export const reduceMeanLumaCpuV3 = (rgba: ArrayLike<number>): number => {
...
export const histogramLumaCpuV3 = (rgba: ArrayLike<number>, bins = 256): Uint32Array => {
...
export const exclusiveScanU32CpuV3 = (input: ArrayLike<number>): Uint32Array => {
...
export interface CompactionResultCpuV3 {
  values: Uint32Array
  indices: Uint32Array
  count: number
}

export const compactByPredicateCpuV3 = (
  input: ArrayLike<number>,
  predicate: (value: number, index: number) => boolean
): CompactionResultCpuV3 => {
  const values: number[] = []
...
export interface RadixSortPairCpuV3 {
  key: number
  value: number
}

export const radixSortKeyValueU32CpuV3 = (pairs: RadixSortPairCpuV3[]): RadixSortPairCpuV3[] => pairs
  .map((pair, index) => ({
    key: pair.key >>> 0,
    value: pair.value >>> 0,
    _stableIndex: index
...
export interface QueueStateCpuV3 {
  active: Uint32Array
  count: number
  overflow: number
}

export const queueAppendConsumeCountCpuV3 = (
  queue: QueueStateCpuV3,
...
export const scatterToTexture2DCpuV3 = (
  width: number,
  height: number,
...
export const gatherFromTexture2DCpuV3 = (
  width: number,
  height: number,
...
export const pyramidDownsampleCpuV3 = (
  width: number,
  height: number,
  texture: ArrayLike<number>
...
export const pyramidUpsampleCpuV3 = (
  width: number,
  height: number,
  texture: ArrayLike<number>,
  targetWidth: number,
