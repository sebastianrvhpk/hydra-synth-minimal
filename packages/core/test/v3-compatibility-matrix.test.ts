...
describe('v3 DSL compatibility matrix', () => {
...
`
  ...
  it('compiles deterministic v3 plans across repeated unchanged DSL scripts', () => {
    ...
    const planA = compileGraphV3(script.transforms, { graphId: 'compat-matrix', selectedVariantPolicy: 'compat' })
    const planB = compileGraphV3(script.transforms, { graphId: 'compat-matrix', selectedVariantPolicy: 'compat' })
