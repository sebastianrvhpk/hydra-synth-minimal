...
.modulate(noise(3,-.5).brightness(.5).posterize(()=>4+(time+64)%128).brightness(-.5).color(1,0,0).add(noise(3,.5).brightness(.5).posterize(()=>7+time%128).brightness(-.5).color(0,1,0))
.pixelate(2,2),.25)
.diff(o0,.9)
.modulate(noise(3,.5).brightness(.5).posterize(()=>4+(time+64)%128).brightness(-.5).color(1,0,0).add(noise(3,-.5).brightness(.5).posterize(()=>7+time%128).brightness(-.5).color(0,1,0))
