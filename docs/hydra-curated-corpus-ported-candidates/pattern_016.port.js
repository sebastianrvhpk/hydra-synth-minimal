...
,2)
.modulateHue(src(o0).hue(()=>time/3).scale(1.025)
     .mask(osc(TAU)
           .modulate(solid(1,0),4/8).thresh(.5,.125/3).pixelate(1,1)),-2)
.modulate(gradient().scale(1, (src(o0).hue(()=>time/3).scale(1.0125)
     .mask(osc(TAU)
           .modulate(solid(1,0),0/8).thresh(.5,.125/3).pixelate(1,1)).color(1/width,1/height)).r(10, 1), (src(o0).hue(()=>time/3).scale(1.0125)
     .mask(osc(TAU)
