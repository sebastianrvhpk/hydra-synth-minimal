...
.layer(solid().layer(src(o1).blend(o0,.5)).mask(shape(4,1,0).scale(.5,A).scale(()=>-time/4%1).modulate(gradient().scale(1, (noise(.3,.25).thresh(-.5,0)).r(1, 1), (noise(.3,.25).thresh(-.5,0)).g(1, 1)).sub(gradient()), 1)))
.out(o2)
render(o2)
