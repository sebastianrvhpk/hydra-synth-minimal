...
ns=(f=.375,v=0,dx=rn(),dy=rn())=>noise(f,v).modulate(solid(1,0),()=>Math.sin(time)).color(0,1)
.add(noise(f,v).modulate(solid(1,0),1).modulate(solid(0,1),()=>Math.cos(time)).color(1,0),1)
