...
.modulate(gradient().scale(1, (noise(3,1).thresh(0,0)).r(rng(0, 8, 8, 2, 0.05), 1), (noise(3,1).thresh(0,0)).g(rng(0, 8, 8, 2, 0.05), 1)).sub(gradient()), 1)
.modulate(o2)
.out(o0)
...
.modulate(gradient().brightness(-.5).repeat(16,16).mask(noise(5,.01).brightness(wob(-1, 1, 0.05)).pixelate(8,8)).color(1/width,1/height),rng(0, 200, 8, 2, 0.05))
.out(o2)
