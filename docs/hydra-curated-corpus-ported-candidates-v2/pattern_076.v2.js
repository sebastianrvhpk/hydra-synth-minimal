/*
Hydra curated corpus port candidate: pattern_076
Title: source block 76
...
.mask(shape(400,1,0).scale(.25/2,1,1,rn(),rn()).repeat(width/4/8,height/4/8,.5,seqSignal(0, 1, 8, 0.25)))
...
src(o0).b().blend(src(o0).r(),oscSignal(0, 1, 0.05)).contrast(2)
.out(o1)
