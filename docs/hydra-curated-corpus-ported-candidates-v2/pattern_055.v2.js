...
shape(4,1,0).modulate(src(o0).color(0,1),oscSignal(-1, 1, 0.05))
.scale(.125,1,1,0,0).repeat(width/8,height/8).modulate(noise(.6,.1).color(0,1).hue(seqSignal(-1, 0, 8, 0.25)).posterize(4,1).hue(seqSignal(0, 1, 8, 0.25)).blend(noise(2,.25).color(1,0),.025).scale(1,.4,1,rn()).rotate(0,1).pixelate(width/8,height/8),.5)
.add(o0,.875)
