...
- single-buffer hard-gated pixel-step feedback: 29
...
- single-buffer hard-gated feedback: 3
...
| --- | --- | --- | --- |
| run_01 | pattern_004, pattern_006 | F01 hard-gated feedback ingress (2); F02 compound/interleaved feedback accumulation (2); F07 transform-delta coordinate field (2); F08 channel / chroma carrier (2); F10 global artifact / blend-pressure feedback (2); F13 direct-transform legacy form (2) | single-buffer hard-gated feedback |
...
| run_03 | pattern_012, pattern_013, pattern_014, pattern_015, pattern_016 | F02 compound/interleaved feedback accumulation (5); F08 channel / chroma carrier (5); F01 hard-gated feedback ingress (4); F05 metric raster / pixel-grid form (4); F07 transform-delta coordinate field (4); F09 kaleid / symmetry recurrence (4) | memory conditioner / artifact feedback -> single-buffer hard-gated pixel-step feedback -> single-buffer hard-gated feedback |
...
| run_05 | pattern_023, pattern_025, pattern_026 | F01 hard-gated feedback ingress (3); F02 compound/interleaved feedback accumulation (3); F05 metric raster / pixel-grid form (3); F12 parameter-signal receiver form (3); F13 direct-transform legacy form (3); F06 axis-packed vector field (2) | single-buffer hard-gated pixel-step feedback |
...
| pattern_003 | multi-buffer feedback pipeline | F02, F03, F10, F12, F13 | read o1,o2 / write o1,o2,o3 / render o3 |
| pattern_004 | single-buffer hard-gated feedback | F01, F02, F06, F07, F08, F10, F13 | read o0 / write o0 / render - |
| pattern_006 | single-buffer hard-gated feedback | F01, F02, F05, F07, F08, F10, F13 | read o0 / write o0 / render o0 |
...
| pattern_014 | single-buffer hard-gated feedback | F01, F02, F05, F07, F08, F09, F10, F13 | read o0 / write o0 / render - |
