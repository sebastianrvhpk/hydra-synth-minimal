/*
Hydra curated corpus port candidate: pattern_067
Title: source block 67
...
osc(Math.PI*width/4,-.1,1.5)
.modulate(shape(1,-1,2).scale(2).rotate(0,1).pixelate(width/8,height/8),1)
.out(o0)
